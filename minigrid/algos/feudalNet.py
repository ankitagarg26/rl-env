...
class FeudalNetAlgo(BaseAlgo):
    ...
    def collect_experiences(self, num_internal_steps):
        ...
        logs = {
            "return_per_episode": round(sum(self.external_rewards), 4),
            "num_steps_per_episode": self.steps,
            "num_episodes": 1
        }
        return logs
    ...
    def update_parameters(self, epoch):
        ...
        logs = {
            ...
            "manager_loss": round((manager_update + manager_value_loss).item(), 4),
            "worker_loss": round((worker_update + worker_value_loss).item(), 4),
        }
